...
Tensor-based log-conformation implementation for viscoelastic fluids,
...
- Use `log-conform-viscoelastic-scalar-3D.h` for 3D.
...
## Provenance
Imported from comphy-lab/MultiRheoFlow (commit 7d9c3df, basilisk-C v2026-08-30). Local patches: MPI-safe abort on a failed eigen decomposition, and a three-phase Gp refresh before div(tau).
*/
...
Gp and lambda are bound in [three-phase-rheology.h](three-phase-rheology.h).
*/
...
event acceleration (i++)
{
  ...
  stress from the current modulus before taking its divergence.
  */
  foreach() {
